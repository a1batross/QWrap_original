...
#define PRECACHE_FILE	(*g_engfuncs.pfnPrecacheGeneric)
...
inline void MESSAGE_BEGIN( int msg_dest, int msg_type, edict_t *ed = NULL ) {
	(*g_engfuncs.pfnMessageBegin)(msg_dest, msg_type, NULL, ed);
}
...
#define GAME_ADD_COMMAND		( *g_engfuncs.pfnAddServerCommand )

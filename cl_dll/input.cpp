...
void InitInput (void)
{
	...
	cl_forwardspeed	= gEngfuncs.pfnRegisterVariable ( "cl_forwardspeed", "200", FCVAR_ARCHIVE );
	cl_backspeed	= gEngfuncs.pfnRegisterVariable ( "cl_backspeed", "200", FCVAR_ARCHIVE );
	cl_sidespeed	= gEngfuncs.pfnRegisterVariable ( "cl_sidespeed", "350", 0 );
	cl_movespeedkey	= gEngfuncs.pfnRegisterVariable ( "cl_movespeedkey", "2.0", 0 );
